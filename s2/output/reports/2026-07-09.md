...
- 港股观察标的：159567.SZ 港股创新药ETF。
- A股温度计状态：589720.SH S1=0.94，状态为强；S1最新日期 20260709，综合得分 0.94，等级 超预期；S1-02=78.14%，S1-05=66.67%，S1-06=7.30%。
- s1_structure_quality = normal；s1_breadth_state = normal。
- S1_score_contribution：flow_score_contribution=0.400；price_strength_contribution=0.040；volume_contribution=0.140；breadth_contribution=0.140；leader_contribution=0.120。
- S1改善主要来自资金回流连续性、ETF份额变化、量能放大；但价格相对强度仍未确认。
...
- HK_observation ETF观察：159567最近5个交易日跑输159557 0.04%，说明港股创新药ETF弱于港股医疗宽基。该观察不进入正式S2分。
...
- 综合客观状态：C；C1；产业事件侧符合预期，BD频率与金额质量均符合预期；交易转化修复中，但未确认；A股温度计强，S1=0.94；latest_valid，港股创新药 ETF 最近 5 个交易日弱于港股医疗宽基。；政策风险升高
...
- 港股观察层：状态=latest_valid。数据源链路：primary=failed，fallback=success，final=tencent_fqkline。159567最近5个交易日跑输159557 0.04%，说明港股创新药ETF弱于港股医疗宽基。该观察层不进入 S2_total，也不改变 adjusted_score。
- S1更新状态：S1指标已更新到 20260709；本地 589720.SH 行情最新交易日为 20260709；fund_share 最新披露日为 20260709。
...
| 产业事件侧得分0.65 | S2-04 success_rate=25.00% | - |
...
| 模块 | 状态 | 说明 |
| --- | --- | --- |
| S1 | valid | 589720行情和指标更新到20260709 |
...
| HK_observation | latest_valid | source=tencent_fqkline；source_status=failed->success；primary_source_status=failed；fallback_source_status=success；latest_date_159567=20260710；latest_date_159557=20260710；common_trade_date=20260710；calendar_lag_days=0；trading_lag_days=0；report_day_price_available_externally=false；local_fetch_failed=false；data_fetch_failed=false |
...
- A股创新药资金状态：强。
- S1趋势状态：s1_weak_streak_days=0；s1_trend_state=温度计修复；s1_recent_direction=下降 -0.02。
- s1_structure_quality = normal；s1_breadth_state = normal。
- S1_score_contribution：flow_score_contribution=0.400；price_strength_contribution=0.040；volume_contribution=0.140；breadth_contribution=0.140；leader_contribution=0.120。
- S1改善主要来自资金回流连续性、ETF份额变化、量能放大；但价格相对强度仍未确认。
- S1最新日期 20260709，综合得分 0.94，等级 超预期；S1-02=78.14%，S1-05=66.67%，S1-06=7.30%。
...
| --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: | --- | --- |
| S2-01 | BD落地频率 | 1.78 | 超预期 | 1.00 | 0.75 | 0.75 | 4 | 0 | 正式评分 | 0 | - | 近90日重大BD 4 笔；前4个完整90日窗口 1/5/2/1 笔，单窗口均值 2.25 |
...
| S2-04 | 数据催化转化率 | 数据缺失 | 数据缺失 | 0.50 | 0.50 | 0.45 | 8 | 0 | 中性占位 | 0 | market_data_audit_blocked: 688192.SH data_quality=missing; reason=latest_trade_date < report_trade_date；589720.SH data_quality=missing; reason=latest_trade_date < report_trade_date；stability_check=source_failed；HTTPError: 403 Client Error: FORBIDDEN for url: https://tushare.citydata.club/fund_daily；最近一次S2-04有效观测已超过5个交易日，不再沿用 | 正式口径：raw_mature_event_count=9；deduped_trade_sample_count=8；success_count=2；success_rate=25.00%；港股事件使用159557.SZ作宽基对照，A股事件使用589720.SH作温度计对照 |
...
- 成熟可计算样本：8；等待满 5 日：0；港股行情缺失/待补：0；本地价格缺失：0。
- 下一批预计成熟日期：暂无。
...
| --- | --- | --- | --- | ---: | --- | --- | ---: | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 康方生物 | 9926.HK | 2026-05-26 | 159557.SZ | 5 | 09926.HK\|20260526\|159557.SZ\|5 | 已满5日 | 0 | 30/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 27/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 27/5 | mature_deduped_duplicate | passed | passed | latest_valid | latest_valid | true | true | 同一 stock_code + event_date + benchmark_code + window_days 已有正式交易样本，本项目仅保留明细 | 否 |
| 康方生物 | 9926.HK | 2026-05-31 | 159557.SZ | 5 | 09926.HK\|20260531\|159557.SZ\|5 | 已满5日 | 0 | 26/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 迪哲医药 | 688192.SH | 2026-05-30 | 589720.SH | 5 | 688192.SH\|20260530\|589720.SH\|5 | 已满5日 | 0 | 27/5 | market_data_audit_blocked | blocked | blocked | missing | missing | false | false | 成熟但不可算 | 否 |
| 康宁杰瑞 | 9966.HK | 2026-06-01 | 159557.SZ | 5 | 09966.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 26/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 先声再明 | 2096.HK | 2026-06-02 | 159557.SZ | 5 | 02096.HK\|20260602\|159557.SZ\|5 | 已满5日 | 0 | 25/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 亚盛医药 | 6855.HK | 2026-06-01 | 159557.SZ | 5 | 06855.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 26/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-06-03 | 159557.SZ | 5 | 06990.HK\|20260603\|159557.SZ\|5 | 已满5日 | 0 | 24/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 信达生物 | 01801.HK | 2026-06-04 | 159557.SZ | 5 | 01801.HK\|20260604\|159557.SZ\|5 | 已满5日 | 0 | 23/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
...
| hk_observation_return_159567 | 1.76% |
| hk_observation_return_159557 | 1.80% |
| hk_observation_excess_159567_vs_159557 | -0.04% |
...
| latest_date_159567 | 20260710 |
| latest_date_159557 | 20260710 |
| common_trade_date | 20260710 |
| report_trade_date | 20260709 |
| lag_days_159567 | 0 |
| lag_days_159557 | 0 |
| calendar_lag_days | 0 |
| trading_lag_days | 0 |
...
| 迪哲医药 / DZD6008 and golidocitinib plus anti-PD-1 | 688192.SH | medium | market_data_audit_blocked | 数据缺失 | 数据缺失 | missing | 数据缺失 | 数据缺失 | missing |
...
- C；C1；产业事件侧符合预期，BD频率与金额质量均符合预期；交易转化修复中，但未确认；A股温度计强，S1=0.94；latest_valid，港股创新药 ETF 最近 5 个交易日弱于港股医疗宽基。；政策风险升高
- final_view_code = C
...
- a_share_temperature_state = A股温度计强，S1=0.94
...
- 具备一致预期来源的业绩样本缺失
- market_data_audit_blocked: 688192.SH data_quality=missing; reason=latest_trade_date < report_trade_date
- 589720.SH data_quality=missing; reason=latest_trade_date < report_trade_date
- stability_check=source_failed
- HTTPError: 403 Client Error: FORBIDDEN for url: https://tushare.citydata.club/fund_daily
...
### 基本面条件
- S1_total >= 0.60：满足，走弱，当前0.94。
- S1-02 份额变化 >= 0：满足，当前78.14%。
- S1-05 板块广度 >= 40%：满足，当前66.67%。
...
- 159567 近5日强于159557：不可确认，最新判断超额=-0.04%；共同交易日历史超额=-0.04%。

### 数据质量条件
- HK日期同步：latest_date_159567=20260710；latest_date_159557=20260710；common_trade_date=20260710。
