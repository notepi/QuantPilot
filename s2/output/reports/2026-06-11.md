...
- 港股观察标的：159567.SZ 港股创新药ETF。
- A股温度计状态：589720.SH S1=0.56，状态为弱；S1最新日期 20260611，综合得分 0.56，等级 低于预期；S1-02=1.06%，S1-05=20.00%，S1-06=1.10%。
- s1_structure_quality = normal；s1_breadth_state = weak_breadth。
- S1_score_contribution：flow_score_contribution=0.280；price_strength_contribution=0.080；volume_contribution=0.056；breadth_contribution=0.056；leader_contribution=0.084。
...
- HK_observation ETF观察：159567最近5个交易日跑输159557 0.39%，说明港股创新药ETF弱于港股医疗宽基。该观察不进入正式S2分。
...
- 综合客观状态：C；C1；产业事件侧符合预期，BD频率与金额质量均符合预期；交易转化修复中，但未确认；A股温度计弱，S1=0.56；latest_valid，港股创新药 ETF 最近 5 个交易日弱于港股医疗宽基。；政策风险升高；risk_off_defensive=false；ai_crowding_unwind=false；biotech_relative_strength=true；hk_innovation_vs_health=positive

- 产业事件状态：今日无新增重大产业事件，产业事件分沿用当前观察窗口。
- 交易转化成熟度：S2-04 去重正式交易样本 9 个，raw成熟事件 10 个，success_rate=22.22%，评级 低于预期；S2-05 评级 符合预期。
- S1/S2组合观察：S2达到符合预期，S1尚未达到
- S2原始得分（raw_score）：0.65
- S2置信度调整后得分（adjusted_score）：0.61
- 正式口径可用权重：90%；缺失指标：1；待验证指标：0；含观察口径指标：0；过期沿用指标：0
- 港股观察层：状态=latest_valid。数据源链路：primary=failed，fallback=success，final=tencent_fqkline。159567最近5个交易日跑输159557 0.39%，说明港股创新药ETF弱于港股医疗宽基。该观察层不进入 S2_total，也不改变 adjusted_score。
- S1更新状态：S1指标已更新到 20260611；本地 589720.SH 行情最新交易日为 20260611。
...
| 正面确认 | 负面确认 | 数据风险/不可确认 |
| --- | --- | --- |
| BD频率符合预期 | S1=0.56仍弱 | S2-03b一致预期缺失 |
| BD金额质量符合预期 | S2_conversion_score=0.55，修复但未确认 | S2-06商业化兑现低置信度 |
| 产业事件侧得分0.64 | 159567跑输159557 | Macro_Risk_Layer核心字段缺失1/10 |
| HK_observation=latest_valid | S1-05=20.00%，weak_breadth | missing |
| missing | S2-04 success_rate=22.22% | missing |
...
| S2-04 pending | 1.00 | 0.00 | -1.00 | ASCO/临床事件等待满5个完整交易日 |
...
| 模块 | 状态 | 说明 |
| --- | --- | --- |
| S1 | valid | 589720行情和指标更新到20260611 |
...
| HK_observation | latest_valid | source=tencent_fqkline；source_status=failed->success；primary_source_status=failed；fallback_source_status=success；latest_date_159567=20260611；latest_date_159557=20260611；common_trade_date=20260611；calendar_lag_days=0；trading_lag_days=0；report_day_price_available_externally=false；local_fetch_failed=false；data_fetch_failed=false |
...
- A股创新药资金状态：弱。
- S1趋势状态：s1_weak_streak_days=0；s1_trend_state=弱势未修复；s1_recent_direction=下降 -0.12。
- s1_structure_quality = normal；s1_breadth_state = weak_breadth。
- S1_score_contribution：flow_score_contribution=0.280；price_strength_contribution=0.080；volume_contribution=0.056；breadth_contribution=0.056；leader_contribution=0.084。
- S1改善主要来自资金/份额流入，非价格强度和广度扩散。
- S1最新日期 20260611，综合得分 0.56，等级 低于预期；S1-02=1.06%，S1-05=20.00%，S1-06=1.10%。
...
| S2-04 | 数据催化转化率 | 22.22% | 低于预期 | 0.40 | 0.40 | 0.90 | 9 | 0 | 正式评分 | 0 | - | 正式口径：raw_mature_event_count=10；deduped_trade_sample_count=9；success_count=2；success_rate=22.22%；港股事件使用159557.SZ作宽基对照，A股事件使用589720.SH作温度计对照 |
| S2-05 | 龙头接力强度 | 0.33% | 符合预期 | 0.70 | 0.70 | 0.70 | 14 | 4 | 正式评分 | 0 | 本地A股龙头池待满5个交易日验证或有效样本少于3只 | 正式口径：核心催化后本地A股龙头池相对 589720.SH 的5日中位超额收益 0.33% |
...
| --- | --- | --- | --- | ---: | --- | --- | ---: | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 康方生物 | 9926.HK | 2026-05-26 | 159557.SZ | 5 | 09926.HK\|20260526\|159557.SZ\|5 | 已满5日 | 0 | 12/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 9/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 9/5 | mature_deduped_duplicate | passed | passed | latest_valid | latest_valid | true | true | 同一 stock_code + event_date + benchmark_code + window_days 已有正式交易样本，本项目仅保留明细 | 否 |
| 康方生物 | 9926.HK | 2026-05-31 | 159557.SZ | 5 | 09926.HK\|20260531\|159557.SZ\|5 | 已满5日 | 0 | 8/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 迪哲医药 | 688192.SH | 2026-05-30 | 589720.SH | 5 | 688192.SH\|20260530\|589720.SH\|5 | 已满5日 | 0 | 8/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 康宁杰瑞 | 9966.HK | 2026-06-01 | 159557.SZ | 5 | 09966.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 8/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 先声再明 | 2096.HK | 2026-06-02 | 159557.SZ | 5 | 02096.HK\|20260602\|159557.SZ\|5 | 已满5日 | 0 | 7/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 亚盛医药 | 6855.HK | 2026-06-01 | 159557.SZ | 5 | 06855.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 8/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-06-03 | 159557.SZ | 5 | 06990.HK\|20260603\|159557.SZ\|5 | 已满5日 | 0 | 6/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 信达生物 | 01801.HK | 2026-06-04 | 159557.SZ | 5 | 01801.HK\|20260604\|159557.SZ\|5 | 已满5日 | 0 | 5/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
...
| hk_observation_return_159567 | -4.87% |
| hk_observation_return_159557 | -4.48% |
| hk_observation_excess_159567_vs_159557 | -0.39% |
...
| latest_date_159567 | 20260611 |
| latest_date_159557 | 20260611 |
| common_trade_date | 20260611 |
| report_trade_date | 20260611 |
| lag_days_159567 | 0 |
| lag_days_159557 | 0 |
| calendar_lag_days | 0 |
| trading_lag_days | 0 |
...
- C；C1；产业事件侧符合预期，BD频率与金额质量均符合预期；交易转化修复中，但未确认；A股温度计弱，S1=0.56；latest_valid，港股创新药 ETF 最近 5 个交易日弱于港股医疗宽基。；政策风险升高；risk_off_defensive=false；ai_crowding_unwind=false；biotech_relative_strength=true；hk_innovation_vs_health=positive
- final_view_code = C
...
- a_share_temperature_state = A股温度计弱，S1=0.56
...
- main_negative_factors = S1=0.56仍弱；S2_conversion_score=0.55，修复但未确认；159567跑输159557；Policy_Risk_Layer=risk_up
...
### 基本面条件
- S1_total >= 0.60：未满足，走弱，当前0.56。
- S1-02 份额变化 >= 0：满足，当前1.06%。
- S1-05 板块广度 >= 40%：未满足，当前20.00%。
...
- S2-05 龙头接力中位超额收益 >= 0：满足，走弱，当前0.33%。

### 持仓标的条件
- 159567 vs 159557 同步行情：满足，HK_observation_status=latest_valid。
- 159567 近5日强于159557：不可确认，最新判断超额=-0.39%；共同交易日历史超额=-0.39%。

### 数据质量条件
- HK日期同步：latest_date_159567=20260611；latest_date_159557=20260611；common_trade_date=20260611。
