...
| S2-05 | 龙头接力强度 | -2.24% | 0.40 | 0.40 | 0.60 | 1 | 0 | 5 | 0 | 低于预期 | 事件库 + leader_pool.csv + 本地行情 | 正式口径：核心催化后本地A股龙头池相对 589720.SH 的5日中位超额收益 -2.24%；本日无新增成熟样本，沿用 2026-05-30 有效观测；待验证 5 个 |
