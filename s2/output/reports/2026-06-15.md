...
- 港股观察标的：159567.SZ 港股创新药ETF。
- A股温度计状态：589720.SH S1=0.60，状态为弱；S1最新日期 20260615，综合得分 0.60，等级 低于预期；S1-02=0.16%，S1-05=40.00%，S1-06=2.56%。
- s1_structure_quality = normal；s1_breadth_state = normal。
- S1_score_contribution：flow_score_contribution=0.280；price_strength_contribution=0.080；volume_contribution=0.056；breadth_contribution=0.098；leader_contribution=0.084。
...
- HK_observation ETF观察：159567最近5个交易日跑赢159557 1.54%，说明港股创新药ETF强于港股医疗宽基。该观察不进入正式S2分。
...
- 综合客观状态：C；C1；产业事件侧符合预期，BD频率与金额质量均符合预期；交易转化修复中，但未确认；A股温度计弱，S1=0.60；latest_valid，港股创新药 ETF 最近 5 个交易日强于港股医疗宽基。；政策风险升高；risk_off_defensive=false；ai_crowding_unwind=false；biotech_relative_strength=true；hk_innovation_vs_health=positive
...
- 港股观察层：状态=latest_valid。数据源链路：primary=failed，fallback=success，final=tencent_fqkline。159567最近5个交易日跑赢159557 1.54%，说明港股创新药ETF强于港股医疗宽基。该观察层不进入 S2_total，也不改变 adjusted_score。
- S1更新状态：S1指标已更新到 20260615；本地 589720.SH 行情最新交易日为 20260615；fund_share 最新披露日为 20260611。
...
| 正面确认 | 负面确认 | 数据风险/不可确认 |
| --- | --- | --- |
| BD频率符合预期 | S1=0.60仍弱 | S2-03b一致预期缺失 |
| BD金额质量符合预期 | S2_conversion_score=0.55，修复但未确认 | S2-06商业化兑现低置信度 |
| 产业事件侧得分0.64 | S1-05=40.00%，normal | Macro_Risk_Layer核心字段缺失1/10 |
...
| 模块 | 状态 | 说明 |
| --- | --- | --- |
| S1 | valid | 589720行情和指标更新到20260615 |
...
| HK_observation | latest_valid | source=tencent_fqkline；source_status=failed->success；primary_source_status=failed；fallback_source_status=success；latest_date_159567=20260615；latest_date_159557=20260615；common_trade_date=20260615；calendar_lag_days=0；trading_lag_days=0；report_day_price_available_externally=false；local_fetch_failed=false；data_fetch_failed=false |
...
- A股创新药资金状态：弱。
- S1趋势状态：s1_weak_streak_days=0；s1_trend_state=弱势未修复；s1_recent_direction=下降 -0.02。
- s1_structure_quality = normal；s1_breadth_state = normal。
- S1_score_contribution：flow_score_contribution=0.280；price_strength_contribution=0.080；volume_contribution=0.056；breadth_contribution=0.098；leader_contribution=0.084。
- S1改善主要来自资金/份额流入，非价格强度和广度扩散。
- S1最新日期 20260615，综合得分 0.60，等级 低于预期；S1-02=0.16%，S1-05=40.00%，S1-06=2.56%。
...
| S2-05 | 龙头接力强度 | 0.78% | 符合预期 | 0.70 | 0.70 | 0.90 | 18 | 0 | 正式评分 | 0 | - | 当前S2-05为沿用观察，不是今日新增验证；正式口径：核心催化后本地A股龙头池相对 589720.SH 的5日中位超额收益 0.78%；本日无新增成熟样本，沿用 2026-06-12 有效观测；待验证 0 个 |

- S2-05 当前为沿用观察，不是今日新增验证。最近有效观测日：2026-06-12；距今 1 个交易日；类型：recent_carry_forward。
...
| --- | --- | --- | --- | ---: | --- | --- | ---: | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 康方生物 | 9926.HK | 2026-05-26 | 159557.SZ | 5 | 09926.HK\|20260526\|159557.SZ\|5 | 已满5日 | 0 | 14/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 11/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 11/5 | mature_deduped_duplicate | passed | passed | latest_valid | latest_valid | true | true | 同一 stock_code + event_date + benchmark_code + window_days 已有正式交易样本，本项目仅保留明细 | 否 |
| 康方生物 | 9926.HK | 2026-05-31 | 159557.SZ | 5 | 09926.HK\|20260531\|159557.SZ\|5 | 已满5日 | 0 | 10/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 迪哲医药 | 688192.SH | 2026-05-30 | 589720.SH | 5 | 688192.SH\|20260530\|589720.SH\|5 | 已满5日 | 0 | 10/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 康宁杰瑞 | 9966.HK | 2026-06-01 | 159557.SZ | 5 | 09966.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 10/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 先声再明 | 2096.HK | 2026-06-02 | 159557.SZ | 5 | 02096.HK\|20260602\|159557.SZ\|5 | 已满5日 | 0 | 9/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 亚盛医药 | 6855.HK | 2026-06-01 | 159557.SZ | 5 | 06855.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 10/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-06-03 | 159557.SZ | 5 | 06990.HK\|20260603\|159557.SZ\|5 | 已满5日 | 0 | 8/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 信达生物 | 01801.HK | 2026-06-04 | 159557.SZ | 5 | 01801.HK\|20260604\|159557.SZ\|5 | 已满5日 | 0 | 7/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
...
| hk_observation_return_159567 | 3.74% |
| hk_observation_return_159557 | 2.20% |
| hk_observation_excess_159567_vs_159557 | 1.54% |
...
| latest_date_159567 | 20260615 |
| latest_date_159557 | 20260615 |
| common_trade_date | 20260615 |
| report_trade_date | 20260615 |
| lag_days_159567 | 0 |
| lag_days_159557 | 0 |
| calendar_lag_days | 0 |
| trading_lag_days | 0 |
...
| 159567 5日收益 | 3.74% |
| 159557 5日收益 | 2.20% |
| 159567 - 159557 5日超额 | 1.54% |
| 159567 10日收益 | -6.87% |
| 159557 10日收益 | -6.72% |
| 159567 - 159557 10日超额 | -0.15% |
...
- C；C1；产业事件侧符合预期，BD频率与金额质量均符合预期；交易转化修复中，但未确认；A股温度计弱，S1=0.60；latest_valid，港股创新药 ETF 最近 5 个交易日强于港股医疗宽基。；政策风险升高；risk_off_defensive=false；ai_crowding_unwind=false；biotech_relative_strength=true；hk_innovation_vs_health=positive
- final_view_code = C
...
- a_share_temperature_state = A股温度计弱，S1=0.60
...
- main_negative_factors = S1=0.60仍弱；S2_conversion_score=0.55，修复但未确认；Policy_Risk_Layer=risk_up
...
### 基本面条件
- S1_total >= 0.60：未满足，走弱，当前0.60。
- S1-02 份额变化 >= 0：满足，当前0.16%。
- S1-05 板块广度 >= 40%：满足，当前40.00%。
...
- 159567 近5日强于159557：满足，最新判断超额=1.54%；共同交易日历史超额=1.54%。

### 数据质量条件
- HK日期同步：latest_date_159567=20260615；latest_date_159557=20260615；common_trade_date=20260615。
