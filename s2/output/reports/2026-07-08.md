...
- 港股观察标的：159567.SZ 港股创新药ETF。
- A股温度计状态：589720.SH S1=0.90，状态为强；S1最新日期 20260708，综合得分 0.90，等级 超预期；S1-02=87.86%，S1-05=53.33%，S1-06=10.11%。
- s1_structure_quality = normal；s1_breadth_state = normal。
- S1_score_contribution：flow_score_contribution=0.400；price_strength_contribution=0.140；volume_contribution=0.140；breadth_contribution=0.098；leader_contribution=0.120。
- S1改善主要来自资金回流连续性、ETF份额变化、量能放大。
...
- HK_observation ETF观察：159567最近5个交易日跑输159557 1.83%，说明港股创新药ETF弱于港股医疗宽基。该观察不进入正式S2分。
...
- 综合客观状态：C；C1；产业事件侧符合预期，BD频率与金额质量均符合预期；交易转化修复中，但未确认；A股温度计强，S1=0.90；latest_valid，港股创新药 ETF 最近 5 个交易日弱于港股医疗宽基。；政策风险升高
...
- 港股观察层：状态=latest_valid。citydata_fund_daily抓取成功。159567最近5个交易日跑输159557 1.83%，说明港股创新药ETF弱于港股医疗宽基。该观察层不进入 S2_total，也不改变 adjusted_score。
- S1更新状态：S1指标已更新到 20260708；本地 589720.SH 行情最新交易日为 20260708；fund_share 最新披露日为 20260708。
...
| 产业事件侧得分0.65 | S1-05=53.33%，normal | - |
| HK_observation=latest_valid | S2-04 success_rate=25.00% | - |
| - | Policy_Risk_Layer=risk_up | - |

## 二、今日变化

| 项目 | 昨日 | 今日 | 变化 | 解释 |
| --- | ---: | ---: | ---: | --- |
| S1_total | 0.94 | 0.90 | -0.04 | 温度计修复 |
...
| 模块 | 状态 | 说明 |
| --- | --- | --- |
| S1 | valid | 589720行情和指标更新到20260708 |
...
| HK_observation | latest_valid | source=citydata_fund_daily；source_status=success->not_used；primary_source_status=success；fallback_source_status=not_used；latest_date_159567=20260708；latest_date_159557=20260708；common_trade_date=20260708；calendar_lag_days=0；trading_lag_days=0；report_day_price_available_externally=false；local_fetch_failed=false；data_fetch_failed=false |
...
- A股创新药资金状态：强。
- S1趋势状态：s1_weak_streak_days=0；s1_trend_state=温度计修复；s1_recent_direction=下降 -0.04。
- s1_structure_quality = normal；s1_breadth_state = normal。
- S1_score_contribution：flow_score_contribution=0.400；price_strength_contribution=0.140；volume_contribution=0.140；breadth_contribution=0.098；leader_contribution=0.120。
- S1改善主要来自资金回流连续性、ETF份额变化、量能放大。
- S1最新日期 20260708，综合得分 0.90，等级 超预期；S1-02=87.86%，S1-05=53.33%，S1-06=10.11%。
...
| --- | --- | --- | --- | ---: | --- | --- | ---: | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 康方生物 | 9926.HK | 2026-05-26 | 159557.SZ | 5 | 09926.HK\|20260526\|159557.SZ\|5 | 已满5日 | 0 | 29/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 26/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 26/5 | mature_deduped_duplicate | passed | passed | latest_valid | latest_valid | true | true | 同一 stock_code + event_date + benchmark_code + window_days 已有正式交易样本，本项目仅保留明细 | 否 |
| 康方生物 | 9926.HK | 2026-05-31 | 159557.SZ | 5 | 09926.HK\|20260531\|159557.SZ\|5 | 已满5日 | 0 | 25/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 迪哲医药 | 688192.SH | 2026-05-30 | 589720.SH | 5 | 688192.SH\|20260530\|589720.SH\|5 | 已满5日 | 0 | 26/5 | missing_price | passed | passed | latest_valid | latest_valid | true | true | 成熟但本地价格缺失，暂不进入正式S2-04 | 否 |
| 康宁杰瑞 | 9966.HK | 2026-06-01 | 159557.SZ | 5 | 09966.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 25/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 先声再明 | 2096.HK | 2026-06-02 | 159557.SZ | 5 | 02096.HK\|20260602\|159557.SZ\|5 | 已满5日 | 0 | 24/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 亚盛医药 | 6855.HK | 2026-06-01 | 159557.SZ | 5 | 06855.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 25/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-06-03 | 159557.SZ | 5 | 06990.HK\|20260603\|159557.SZ\|5 | 已满5日 | 0 | 23/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 信达生物 | 01801.HK | 2026-06-04 | 159557.SZ | 5 | 01801.HK\|20260604\|159557.SZ\|5 | 已满5日 | 0 | 22/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
...
| hk_observation_return_159567 | 4.22% |
| hk_observation_return_159557 | 6.05% |
| hk_observation_excess_159567_vs_159557 | -1.83% |
...
| latest_date_159567 | 20260708 |
| latest_date_159557 | 20260708 |
| common_trade_date | 20260708 |
| report_trade_date | 20260708 |
| lag_days_159567 | 0 |
| lag_days_159557 | 0 |
| calendar_lag_days | 0 |
| trading_lag_days | 0 |
...
- C；C1；产业事件侧符合预期，BD频率与金额质量均符合预期；交易转化修复中，但未确认；A股温度计强，S1=0.90；latest_valid，港股创新药 ETF 最近 5 个交易日弱于港股医疗宽基。；政策风险升高
- final_view_code = C
...
- a_share_temperature_state = A股温度计强，S1=0.90
...
### 基本面条件
- S1_total >= 0.60：满足，走弱，当前0.90。
- S1-02 份额变化 >= 0：满足，当前87.86%。
- S1-05 板块广度 >= 40%：满足，当前53.33%。
...
- 159567 近5日强于159557：不可确认，最新判断超额=-1.83%；共同交易日历史超额=-1.83%。

### 数据质量条件
- HK日期同步：latest_date_159567=20260708；latest_date_159557=20260708；common_trade_date=20260708。
