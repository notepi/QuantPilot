...
- 港股观察标的：159567.SZ 港股创新药ETF。
- A股温度计状态：589720.SH S1=0.93，状态为强；S1最新日期 20260701，综合得分 0.93，等级 超预期；S1-02=31.48%，S1-05=93.33%，S1-06=13.23%。
- s1_structure_quality = normal；s1_breadth_state = normal。
- S1_score_contribution：flow_score_contribution=0.334；price_strength_contribution=0.200；volume_contribution=0.140；breadth_contribution=0.140；leader_contribution=0.120。
- S1改善主要来自ETF份额变化、价格相对强度、量能放大。
...
- HK_observation ETF观察：159567最近5个交易日跑赢159557 3.60%，说明港股创新药ETF强于港股医疗宽基。该观察不进入正式S2分。
...
- 综合客观状态：C；C1；产业事件侧符合预期，BD频率与金额质量均符合预期；交易转化修复中，但未确认；A股温度计强，S1=0.93；latest_valid，港股创新药 ETF 最近 5 个交易日强于港股医疗宽基。；政策风险升高

- 产业事件状态：今日无新增重大产业事件，产业事件分沿用当前观察窗口。
- 交易转化成熟度：S2-04 去重正式交易样本 1 个，raw成熟事件 1 个，历史观测 success_rate=0.00%，当前不再沿用，正式评级=数据缺失；S2-05 历史观测，当前不再沿用，正式评级=数据缺失。
...
- 港股观察层：状态=latest_valid。citydata_fund_daily抓取成功。159567最近5个交易日跑赢159557 3.60%，说明港股创新药ETF强于港股医疗宽基。该观察层不进入 S2_total，也不改变 adjusted_score。
- S1更新状态：S1指标已更新到 20260701；本地 589720.SH 行情最新交易日为 20260701；fund_share 最新披露日为 20260701。
...
| BD金额质量符合预期 | S2-04 success_rate=0.00% | S2-06商业化兑现低置信度 |
...
| 模块 | 状态 | 说明 |
| --- | --- | --- |
| S1 | valid | 589720行情和指标更新到20260701 |
| S2事件库 | valid | 今日新增0条确认事件 |
| 事件去重检查 | 有待复核 | is_duplicate=true 的事件不进入正式统计 |
| S2-04交易转化 | valid | raw_mature_event_count=1；deduped_trade_sample_count=1；0个事件未满5日 |
| HK_observation | latest_valid | source=citydata_fund_daily；source_status=success->not_used；primary_source_status=success；fallback_source_status=not_used；latest_date_159567=20260701；latest_date_159557=20260701；common_trade_date=20260701；calendar_lag_days=0；trading_lag_days=0；report_day_price_available_externally=false；local_fetch_failed=false；data_fetch_failed=false |
...
- S1_score_contribution：flow_score_contribution=0.334；price_strength_contribution=0.200；volume_contribution=0.140；breadth_contribution=0.140；leader_contribution=0.120。
- S1改善主要来自ETF份额变化、价格相对强度、量能放大。
- S1最新日期 20260701，综合得分 0.93，等级 超预期；S1-02=31.48%，S1-05=93.33%，S1-06=13.23%。
...
- S2-04_official_sample_count：1。
- raw_mature_event_count：1。
- deduped_trade_sample_count：1。
- success_count：0。
- success_rate：0.00%。
- S2-04_hk_event_pending_count：9。
- S2-04_hk_event_pending_or_missing_count：9。
- HK_observation_status：159567 强于 159557。
- 港股临床事件若本地 `s2/data/hk_daily.csv` 有完整个股价格，则进入 S2-04 正式样本；缺行情时列明缺失标的，不编造。
- 成熟可计算样本：1；等待满 5 日：0；港股行情缺失/待补：0；本地价格缺失：0。
- 下一批预计成熟日期：暂无。
...
| --- | --- | --- | --- | ---: | --- | --- | ---: | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 康方生物 | 9926.HK | 2026-05-26 | 159557.SZ | 5 | 09926.HK\|20260526\|159557.SZ\|5 | 已满5日 | 0 | 24/5 | market_data_audit_blocked | blocked | passed | stale | latest_valid | false | true | 成熟但不可算 | 否 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 21/5 | market_data_audit_blocked | blocked | passed | stale | latest_valid | false | true | 成熟但不可算 | 否 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 21/5 | market_data_audit_blocked | blocked | passed | stale | latest_valid | false | true | 成熟但不可算 | 否 |
| 康方生物 | 9926.HK | 2026-05-31 | 159557.SZ | 5 | 09926.HK\|20260531\|159557.SZ\|5 | 已满5日 | 0 | 20/5 | market_data_audit_blocked | blocked | passed | stale | latest_valid | false | true | 成熟但不可算 | 否 |
| 迪哲医药 | 688192.SH | 2026-05-30 | 589720.SH | 5 | 688192.SH\|20260530\|589720.SH\|5 | 已满5日 | 0 | 21/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 康宁杰瑞 | 9966.HK | 2026-06-01 | 159557.SZ | 5 | 09966.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 20/5 | market_data_audit_blocked | blocked | passed | stale | latest_valid | false | true | 成熟但不可算 | 否 |
| 先声再明 | 2096.HK | 2026-06-02 | 159557.SZ | 5 | 02096.HK\|20260602\|159557.SZ\|5 | 已满5日 | 0 | 19/5 | market_data_audit_blocked | blocked | passed | stale | latest_valid | false | true | 成熟但不可算 | 否 |
| 亚盛医药 | 6855.HK | 2026-06-01 | 159557.SZ | 5 | 06855.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 20/5 | market_data_audit_blocked | blocked | passed | stale | latest_valid | false | true | 成熟但不可算 | 否 |
| 科伦博泰 | 6990.HK | 2026-06-03 | 159557.SZ | 5 | 06990.HK\|20260603\|159557.SZ\|5 | 已满5日 | 0 | 18/5 | market_data_audit_blocked | blocked | passed | stale | latest_valid | false | true | 成熟但不可算 | 否 |
| 信达生物 | 01801.HK | 2026-06-04 | 159557.SZ | 5 | 01801.HK\|20260604\|159557.SZ\|5 | 已满5日 | 0 | 17/5 | market_data_audit_blocked | blocked | passed | stale | latest_valid | false | true | 成熟但不可算 | 否 |
...
| hk_observation_return_159567 | 7.02% |
| hk_observation_return_159557 | 3.42% |
| hk_observation_excess_159567_vs_159557 | 3.60% |
...
| latest_date_159567 | 20260701 |
| latest_date_159557 | 20260701 |
| common_trade_date | 20260701 |
| report_trade_date | 20260701 |
| lag_days_159567 | 0 |
| lag_days_159557 | 0 |
| calendar_lag_days | 0 |
| trading_lag_days | 0 |
...
- 今日是否出现反证信号：是。
  - S2总分改善但临床事件交易转化仍为0，不能视为事件催化确认
  - BD出海估值折价风险
  - 港股创新药风险偏好压制

| 临床事件 | 标的 | 相关性 | 成熟状态 | 个股5日 | 个股-159567 | 个股-159567_scope | 个股-159557 | 159567-159557 | 159567-159557_scope |
| --- | --- | --- | --- | ---: | ---: | --- | ---: | ---: | --- |
| 康方生物 / ivonescimab HARMONi-6 | 9926.HK | high | market_data_audit_blocked | 数据缺失 | 数据缺失 | missing | 数据缺失 | 数据缺失 | missing |
| 科伦博泰 / sacituzumab tirumotecan (sac-TMT) OptiTROP-Lung05 | 6990.HK | high | market_data_audit_blocked | 数据缺失 | 数据缺失 | missing | 数据缺失 | 数据缺失 | missing |
| 科伦博泰 / lunbotinib fumarate (A400/EP0031) | 6990.HK | high | market_data_audit_blocked | 数据缺失 | 数据缺失 | missing | 数据缺失 | 数据缺失 | missing |
| 康方生物 / ivonescimab HARMONi-6 | 9926.HK | high | market_data_audit_blocked | 数据缺失 | 数据缺失 | missing | 数据缺失 | 数据缺失 | missing |
...
| 康宁杰瑞 / anbenitamab (KN026) plus HB1801 | 9966.HK | high | market_data_audit_blocked | 数据缺失 | 数据缺失 | missing | 数据缺失 | 数据缺失 | missing |
| 先声再明 / SIM0505 (CDH6 ADC) | 2096.HK | high | market_data_audit_blocked | 数据缺失 | 数据缺失 | missing | 数据缺失 | 数据缺失 | missing |
| 亚盛医药 / olverembatinib (HQP1351) plus blinatumomab | 6855.HK | high | market_data_audit_blocked | 数据缺失 | 数据缺失 | missing | 数据缺失 | 数据缺失 | missing |
| 科伦博泰 / SKB500 (B7-H3 ADC) | 6990.HK | high | market_data_audit_blocked | 数据缺失 | 数据缺失 | missing | 数据缺失 | 数据缺失 | missing |
| 信达生物 / IBI343 (arcotatug vedotin) | 01801.HK | high | market_data_audit_blocked | 数据缺失 | 数据缺失 | missing | 数据缺失 | 数据缺失 | missing |

## 十二、第四层：final_view_客观状态汇总

- C；C1；产业事件侧符合预期，BD频率与金额质量均符合预期；交易转化修复中，但未确认；A股温度计强，S1=0.93；latest_valid，港股创新药 ETF 最近 5 个交易日强于港股医疗宽基。；政策风险升高
- final_view_code = C
...
- a_share_temperature_state = A股温度计强，S1=0.93
...
- main_negative_factors = S2_conversion_score=0.50，修复但未确认；S2-04 success_rate=0.00%；Policy_Risk_Layer=risk_up
...
- 具备一致预期来源的业绩样本缺失
- market_data_audit_blocked: 9926.HK data_quality=stale; reason=latest_trade_date < report_trade_date
- market_data_audit_blocked: 6990.HK data_quality=stale; reason=latest_trade_date < report_trade_date
- market_data_audit_blocked: 9966.HK data_quality=stale; reason=latest_trade_date < report_trade_date
- market_data_audit_blocked: 2096.HK data_quality=stale; reason=latest_trade_date < report_trade_date
- market_data_audit_blocked: 6855.HK data_quality=stale; reason=latest_trade_date < report_trade_date
- market_data_audit_blocked: 01801.HK data_quality=stale; reason=latest_trade_date < report_trade_date
...
### 基本面条件
- S1_total >= 0.60：满足，持平，当前0.93。
- S1-02 份额变化 >= 0：满足，当前31.48%。
- S1-05 板块广度 >= 40%：满足，当前93.33%。
- S2_event_score >= 0.60：满足，持平，当前0.65。

### 交易转化条件
- S2_conversion_score >= 0.60：未满足，交易转化修复中，但未确认，当前0.50。
- S2-04 去重正式样本 >= 3：未满足，当前1个；raw_mature_event_count=1。
- S2-04 success_rate > 0：未满足，success_count=0，success_rate=0.00%。
- S2-05 龙头接力中位超额收益 >= 0：未满足，方向未知，当前数据缺失。

### 持仓标的条件
- 159567 vs 159557 同步行情：满足，HK_observation_status=latest_valid。
- 159567 近5日强于159557：满足，最新判断超额=3.60%；共同交易日历史超额=3.60%。

### 数据质量条件
- HK日期同步：latest_date_159567=20260701；latest_date_159557=20260701；common_trade_date=20260701。
