...
- 港股观察标的：159567.SZ 港股创新药ETF。
- A股温度计状态：589720.SH S1=0.68，状态为中性；S1最新日期 20260609，综合得分 0.68，等级 符合预期；S1-02=9.15%，S1-05=13.33%，S1-06=0.67%。
- s1_structure_quality = weak_breadth_repair；s1_breadth_state = weak_breadth。
...
- HK_observation ETF观察：159567最近5个交易日跑赢159557 0.38%，说明港股创新药ETF强于港股医疗宽基。该观察不进入正式S2分。
- 下一批S2-04事件将在2026-06-10开始成熟，届时可开始观察临床事件5日交易转化。
- 日间变化说明：产业事件侧与前一日持平；交易转化侧状态为交易转化修复中，但未确认。
- S2解释性状态：一致预期验证缺数据；财报客观改善有效，但不能冒充超一致预期。
- 港股观察层：159567 数据状态为 latest_valid；可判断相对强弱。
- 综合客观状态：C；C1；产业事件侧符合预期，BD频率与金额质量均符合预期；交易转化修复中，但未确认；A股温度计中性，S1=0.68；latest_valid，港股创新药 ETF 最近 5 个交易日强于港股医疗宽基。；政策风险升高；risk_off_defensive=false；ai_crowding_unwind=false；biotech_relative_strength=true；hk_innovation_vs_health=positive

- 产业事件状态：今日无新增重大产业事件，产业事件分沿用当前观察窗口。
- 交易转化成熟度：S2-04 去重正式交易样本 7 个，raw成熟事件 8 个，success_rate=14.29%，评级 低于预期；S2-05 评级 符合预期。
...
- 港股观察层：状态=latest_valid。数据源链路：primary=failed，fallback=success，final=tencent_fqkline。159567最近5个交易日跑赢159557 0.38%，说明港股创新药ETF强于港股医疗宽基。该观察层不进入 S2_total，也不改变 adjusted_score。
- S1更新状态：S1指标已更新到 20260609；本地 589720.SH 行情最新交易日为 20260609。
...
| BD金额质量符合预期 | S1-05=13.33%，weak_breadth | S2-06商业化兑现低置信度 |
| 产业事件侧得分0.64 | S2-04 success_rate=14.29% | Macro_Risk_Layer核心字段缺失1/10 |
...
| 项目 | 昨日 | 今日 | 变化 | 解释 |
| --- | ---: | ---: | ---: | --- |
| S1_total | 0.68 | 0.68 | +0.00 | 温度计修复 |
| S2_adjusted | 0.61 | 0.61 | +0.00 | 产业事件侧与前一日持平；交易转化侧状态为交易转化修复中，但未确认。 |
| S2_event_score | 0.64 | 0.64 | +0.00 | 产业事件侧符合预期 |
| S2_conversion_score | 0.55 | 0.55 | +0.00 | 交易转化修复中，但未确认 |
| S2-04 pending | 3.00 | 2.00 | -1.00 | ASCO/临床事件等待满5个完整交易日 |
...
| 模块 | 状态 | 说明 |
| --- | --- | --- |
| S1 | valid | 589720行情和指标更新到20260609 |
| S2事件库 | valid | 今日新增0条确认事件 |
| 事件去重检查 | 有待复核 | is_duplicate=true 的事件不进入正式统计 |
| S2-04交易转化 | pending | raw_mature_event_count=8；deduped_trade_sample_count=7；2个事件未满5日 |
| HK_observation | latest_valid | source=tencent_fqkline；source_status=failed->success；primary_source_status=failed；fallback_source_status=success；latest_date_159567=20260609；latest_date_159557=20260609；common_trade_date=20260609；calendar_lag_days=0；trading_lag_days=0；report_day_price_available_externally=false；local_fetch_failed=false；data_fetch_failed=false |
...
- S1_score_contribution：flow_score_contribution=0.400；price_strength_contribution=0.080；volume_contribution=0.056；breadth_contribution=0.056；leader_contribution=0.084。
- S1改善主要来自资金/份额流入，非价格强度和广度扩散。
- S1最新日期 20260609，综合得分 0.68，等级 符合预期；S1-02=9.15%，S1-05=13.33%，S1-06=0.67%。
...
| S2-04 | 数据催化转化率 | 14.29% | 低于预期 | 0.40 | 0.40 | 0.70 | 7 | 2 | 正式评分 | 2 | 6990.HK待满5个交易日验证；01801.HK待满5个交易日验证 | 正式口径：raw_mature_event_count=8；deduped_trade_sample_count=7；success_count=1；success_rate=14.29%；港股事件使用159557.SZ作宽基对照，A股事件使用589720.SH作温度计对照 |
| S2-05 | 龙头接力强度 | 0.78% | 符合预期 | 0.70 | 0.70 | 0.70 | 12 | 6 | 正式评分 | 0 | 589720.SH待满5个交易日验证 | 正式口径：核心催化后本地A股龙头池相对 589720.SH 的5日中位超额收益 0.78% |
...
- S2-04_official_sample_count：7。
- raw_mature_event_count：8。
- deduped_trade_sample_count：7。
- success_count：1。
- success_rate：14.29%。
- S2-04_hk_event_pending_count：3。
- S2-04_hk_event_pending_or_missing_count：3。
- HK_observation_status：159567 强于 159557。
- 港股临床事件若本地 `s2/data/hk_daily.csv` 有完整个股价格，则进入 S2-04 正式样本；缺行情时列明缺失标的，不编造。
- 成熟可计算样本：7；等待满 5 日：2；港股行情缺失/待补：0；本地价格缺失：0。
- 下一批预计成熟日期：2026-06-10, 2026-06-11。
...
| --- | --- | --- | --- | ---: | --- | --- | ---: | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 康方生物 | 9926.HK | 2026-05-26 | 159557.SZ | 5 | 09926.HK\|20260526\|159557.SZ\|5 | 已满5日 | 0 | 10/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 7/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 7/5 | mature_deduped_duplicate | passed | passed | latest_valid | latest_valid | true | true | 同一 stock_code + event_date + benchmark_code + window_days 已有正式交易样本，本项目仅保留明细 | 否 |
| 康方生物 | 9926.HK | 2026-05-31 | 159557.SZ | 5 | 09926.HK\|20260531\|159557.SZ\|5 | 已满5日 | 0 | 6/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 迪哲医药 | 688192.SH | 2026-05-30 | 589720.SH | 5 | 688192.SH\|20260530\|589720.SH\|5 | 已满5日 | 0 | 6/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 康宁杰瑞 | 9966.HK | 2026-06-01 | 159557.SZ | 5 | 09966.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 6/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 先声再明 | 2096.HK | 2026-06-02 | 159557.SZ | 5 | 02096.HK\|20260602\|159557.SZ\|5 | 已满5日 | 0 | 5/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 亚盛医药 | 6855.HK | 2026-06-01 | 159557.SZ | 5 | 06855.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 6/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-06-03 | 159557.SZ | 5 | 06990.HK\|20260603\|159557.SZ\|5 | 2026-06-10 | 1 | 4/5 | pending_not_enough_days | passed | passed | latest_valid | latest_valid | true | true | 未满5个完整交易日 | 否 |
| 信达生物 | 01801.HK | 2026-06-04 | 159557.SZ | 5 | 01801.HK\|20260604\|159557.SZ\|5 | 2026-06-11 | 2 | 3/5 | pending_not_enough_days | passed | passed | latest_valid | latest_valid | true | true | 未满5个完整交易日 | 否 |
...
| hk_observation_return_159567 | -7.84% |
| hk_observation_return_159557 | -8.22% |
| hk_observation_excess_159567_vs_159557 | 0.38% |
...
| latest_date_159567 | 20260609 |
| latest_date_159557 | 20260609 |
| common_trade_date | 20260609 |
| report_trade_date | 20260609 |
| lag_days_159567 | 0 |
| lag_days_159557 | 0 |
| calendar_lag_days | 0 |
| trading_lag_days | 0 |
...
| 数据源 | citydata_fund_daily+tencent_fqkline |
...
- 今日是否出现反证信号：是。
  - S1_total=0.68 但 S1-05=13.33%：A股温度计可能虚修复
  - BD出海估值折价风险
  - 港股创新药风险偏好压制
...
| 先声再明 / SIM0505 (CDH6 ADC) | 2096.HK | high | mature_calculable | -4.10% | 数据缺失 | missing | 4.11% | 数据缺失 | missing |
...
- C；C1；产业事件侧符合预期，BD频率与金额质量均符合预期；交易转化修复中，但未确认；A股温度计中性，S1=0.68；latest_valid，港股创新药 ETF 最近 5 个交易日强于港股医疗宽基。；政策风险升高；risk_off_defensive=false；ai_crowding_unwind=false；biotech_relative_strength=true；hk_innovation_vs_health=positive
- final_view_code = C
...
- main_negative_factors = S2_conversion_score=0.55，修复但未确认；Policy_Risk_Layer=risk_up
- next_validation_dates = 2026-06-10, 2026-06-11
...
### 基本面条件
- S1_total >= 0.60：满足，持平，当前0.68。
- S1-02 份额变化 >= 0：满足，当前9.15%。
- S1-05 板块广度 >= 40%：未满足，当前13.33%。
- S2_event_score >= 0.60：满足，持平，当前0.64。

### 交易转化条件
- S2_conversion_score >= 0.60：未满足，交易转化修复中，但未确认，当前0.55。
- S2-04 去重正式样本 >= 3：满足，当前7个；raw_mature_event_count=8。
- S2-04 success_rate > 0：满足，success_count=1，success_rate=14.29%。
- S2-05 龙头接力中位超额收益 >= 0：满足，改善，当前0.78%。

### 持仓标的条件
- 159567 vs 159557 同步行情：满足，HK_observation_status=latest_valid。
- 159567 近5日强于159557：满足，最新判断超额=0.38%；共同交易日历史超额=0.38%。

### 数据质量条件
- HK日期同步：latest_date_159567=20260609；latest_date_159557=20260609；common_trade_date=20260609。
