...
- 港股观察标的：159567.SZ 港股创新药ETF。
- A股温度计状态：589720.SH S1=0.66，状态为中性；S1最新日期 20260622，综合得分 0.66，等级 符合预期；S1-02=-3.53%，S1-05=53.33%，S1-06=2.06%。
- s1_structure_quality = normal；s1_breadth_state = normal。
- S1_score_contribution：flow_score_contribution=0.226；price_strength_contribution=0.200；volume_contribution=0.056；breadth_contribution=0.098；leader_contribution=0.084。
- S1改善主要来自资金/份额流入，非价格强度和广度扩散。
- S2正式量化等级：adjusted_score=0.62，等级为符合预期。
...
- HK_observation ETF观察：159567最近5个交易日跑输159557 0.47%，说明港股创新药ETF弱于港股医疗宽基。该观察不进入正式S2分。
...
- 综合客观状态：C；C1；产业事件侧符合预期，BD频率与金额质量均符合预期；交易转化修复中，但未确认；A股温度计中性，S1=0.66；latest_valid，港股创新药 ETF 最近 5 个交易日弱于港股医疗宽基。；政策风险升高

- 产业事件状态：今日无新增重大产业事件，产业事件分沿用当前观察窗口。
- 交易转化成熟度：S2-04 去重正式交易样本 9 个，raw成熟事件 10 个，success_rate=22.22%，评级 数据缺失；S2-05 评级 符合预期。
- S1/S2组合观察：S1/S2总分达到符合预期，但关键交易确认项仍未达标。
- S2原始得分（raw_score）：0.73
- S2置信度调整后得分（adjusted_score）：0.62
- 正式口径可用权重：70%；缺失指标：2；待验证指标：0；含观察口径指标：0；过期沿用指标：1
- 港股观察层：状态=latest_valid。数据源链路：primary=failed，fallback=success，final=tencent_fqkline。159567最近5个交易日跑输159557 0.47%，说明港股创新药ETF弱于港股医疗宽基。该观察层不进入 S2_total，也不改变 adjusted_score。
- S1更新状态：S1指标已更新到 20260622；本地 589720.SH 行情最新交易日为 20260622；fund_share 最新披露日为 20260618。
...
| 产业事件侧得分0.65 | S1-05=53.33%，normal | missing |
...
| 项目 | 昨日 | 今日 | 变化 | 解释 |
| --- | ---: | ---: | ---: | --- |
| S1_total | 0.61 | 0.66 | +0.05 | 温度计修复 |
| S2_adjusted | 0.60 | 0.62 | +0.02 | 产业事件侧与前一日持平；交易转化侧状态为交易转化修复中，但未确认。 |
| S2_event_score | 0.65 | 0.65 | +0.00 | 产业事件侧符合预期 |
| S2_conversion_score | 0.50 | 0.55 | +0.05 | 交易转化修复中，但未确认 |
...
| 模块 | 状态 | 说明 |
| --- | --- | --- |
| S1 | valid | 589720行情和指标更新到20260622 |
...
- A股创新药资金状态：中性。
- S1趋势状态：s1_weak_streak_days=0；s1_trend_state=温度计修复；s1_recent_direction=上升 +0.05。
- s1_structure_quality = normal；s1_breadth_state = normal。
- S1_score_contribution：flow_score_contribution=0.226；price_strength_contribution=0.200；volume_contribution=0.056；breadth_contribution=0.098；leader_contribution=0.084。
- S1改善主要来自资金/份额流入，非价格强度和广度扩散。
- S1最新日期 20260622，综合得分 0.66，等级 符合预期；S1-02=-3.53%，S1-05=53.33%，S1-06=2.06%。
...
- S2-05 当前为沿用观察，不是今日新增验证。最近有效观测日：2026-06-12；距今 5 个交易日；类型：aging_carry_forward。
...
| --- | --- | --- | --- | ---: | --- | --- | ---: | ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 康方生物 | 9926.HK | 2026-05-26 | 159557.SZ | 5 | 09926.HK\|20260526\|159557.SZ\|5 | 已满5日 | 0 | 18/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 15/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 15/5 | mature_deduped_duplicate | passed | passed | latest_valid | latest_valid | true | true | 同一 stock_code + event_date + benchmark_code + window_days 已有正式交易样本，本项目仅保留明细 | 否 |
| 康方生物 | 9926.HK | 2026-05-31 | 159557.SZ | 5 | 09926.HK\|20260531\|159557.SZ\|5 | 已满5日 | 0 | 14/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 迪哲医药 | 688192.SH | 2026-05-30 | 589720.SH | 5 | 688192.SH\|20260530\|589720.SH\|5 | 已满5日 | 0 | 14/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 康宁杰瑞 | 9966.HK | 2026-06-01 | 159557.SZ | 5 | 09966.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 14/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 先声再明 | 2096.HK | 2026-06-02 | 159557.SZ | 5 | 02096.HK\|20260602\|159557.SZ\|5 | 已满5日 | 0 | 13/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 亚盛医药 | 6855.HK | 2026-06-01 | 159557.SZ | 5 | 06855.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 14/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-06-03 | 159557.SZ | 5 | 06990.HK\|20260603\|159557.SZ\|5 | 已满5日 | 0 | 12/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
| 信达生物 | 01801.HK | 2026-06-04 | 159557.SZ | 5 | 01801.HK\|20260604\|159557.SZ\|5 | 已满5日 | 0 | 11/5 | mature_calculable | passed | passed | latest_valid | latest_valid | true | true | 成熟可算 | 是 |
...
| hk_observation_return_159567 | -3.12% |
| hk_observation_return_159557 | -2.65% |
| hk_observation_excess_159567_vs_159557 | -0.47% |
...
| latest_date_159567 | 20260622 |
| latest_date_159557 | 20260622 |
| common_trade_date | 20260622 |
| report_trade_date | 20260622 |
| lag_days_159567 | 0 |
| lag_days_159557 | 0 |
| calendar_lag_days | 0 |
| trading_lag_days | 0 |
...
| 159567 5日收益 | -3.12% |
| 159557 5日收益 | -2.65% |
| 159567 - 159557 5日超额 | -0.47% |
| 159567 10日收益 | -3.28% |
| 159557 10日收益 | -3.92% |
| 159567 - 159557 10日超额 | 0.64% |
...
- C；C1；产业事件侧符合预期，BD频率与金额质量均符合预期；交易转化修复中，但未确认；A股温度计中性，S1=0.66；latest_valid，港股创新药 ETF 最近 5 个交易日弱于港股医疗宽基。；政策风险升高
- final_view_code = C
...
- a_share_temperature_state = A股温度计中性，S1=0.66
...
- main_negative_factors = S2_conversion_score=0.55，修复但未确认；159567跑输159557；Policy_Risk_Layer=risk_up
...
### 基本面条件
- S1_total >= 0.60：满足，改善，当前0.66。
- S1-02 份额变化 >= 0：未满足，当前-3.53%。
...
- 159567 近5日强于159557：不可确认，最新判断超额=-0.47%；共同交易日历史超额=-0.47%。

### 数据质量条件
- HK日期同步：latest_date_159567=20260622；latest_date_159557=20260622；common_trade_date=20260622。
