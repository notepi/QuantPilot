...
| S2-02 | BD金额质量 | 1,600,000,000 USD | 1.00 | 0.65 | 0.60 | 2 | 0 | 超预期 | bd_events.csv | 近90日首付款+近期里程碑合计 1,600,000,000 USD |
| S2-03 | 龙头业绩兑现率 | 100.00% | 1.00 | 0.65 | 0.60 | 1 | 0 | 超预期 | earnings_events.csv | 1/1 个已披露龙头事件标记为超预期 |
| S2-04 | 数据催化转化率 | 100.00% | 1.00 | 0.65 | 0.60 | 1 | 1 | 超预期 | clinical_events.csv + 本地行情 | 1/1 个临床事件交易样本跑赢参照；其中 1 个因标的行情缺失，使用 589720.SH 跑赢 159557.SZ 作为ETF承接替代口径 |
