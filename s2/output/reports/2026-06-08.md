...
- 港股观察标的：159567.SZ 港股创新药ETF。
- A股温度计状态：589720.SH S1=0.68，状态为中性；S1最新日期 20260608，综合得分 0.68，等级 符合预期；S1-02=9.15%，S1-05=6.67%，S1-06=1.60%。
- s1_structure_quality = weak_breadth_repair；s1_breadth_state = breadth_collapse。
- S1_score_contribution：flow_score_contribution=0.400；price_strength_contribution=0.080；volume_contribution=0.056；breadth_contribution=0.056；leader_contribution=0.084。
- S1改善主要来自资金/份额流入，非价格强度和广度扩散。
- S2正式量化等级：adjusted_score=0.61，等级为符合预期。
- S2产业事件侧得分：S2_event_score=0.64，状态为符合预期。
- S2交易转化侧得分：S2_conversion_score=0.55，状态为交易转化修复中，但未确认。
- BD联动解释：BD频率与金额质量均符合预期，说明产业事件侧较前期改善；但该改善尚未通过S2-04和S2-05转化为交易确认。
- HK_observation ETF观察：159567最近5个交易日跑输159557 1.50%，说明港股创新药ETF弱于港股医疗宽基。该观察不进入正式S2分。
- 下一批S2-04事件将在2026-06-09开始成熟，届时可开始观察临床事件5日交易转化。
- 日间变化说明：产业事件侧较前一日改善；交易转化侧状态为交易转化修复中，但未确认。
- S2解释性状态：一致预期验证缺数据；财报客观改善有效，但不能冒充超一致预期。
- 港股观察层：159567 数据状态为 latest_valid；可判断相对强弱。
- 综合客观状态：产业事件侧符合预期，但交易转化修复未确认；S1总分改善但广度坍缩；S2-04样本数量满足但成功率为0；159567同步行情已恢复，近5日相对159557仍偏弱，因此159567是否右侧仍需继续验证。

- 产业事件状态：今日无新增重大产业事件，产业事件分沿用当前观察窗口。
- 交易转化成熟度：S2-04 去重正式交易样本 6 个，raw成熟事件 7 个，success_rate=0.00%，评级 低于预期；S2-05 评级 符合预期。样本数量满足，但交易转化失败。
- S1/S2组合观察：S1/S2总分达到符合预期，但关键交易确认项仍未达标。
- S2原始得分（raw_score）：0.65
- S2置信度调整后得分（adjusted_score）：0.61
- 正式口径可用权重：90%；缺失指标：1；待验证指标：0；含观察口径指标：0；过期沿用指标：0
- 港股观察层：状态=latest_valid。citydata_fund_daily与eastmoney本次抓取均失败，使用已更新至报告日的本地缓存；latest_date_159567=20260608，latest_date_159557=20260608。159567最近5个交易日跑输159557 1.50%，说明港股创新药ETF弱于港股医疗宽基。该观察层不进入 S2_total，也不改变 adjusted_score。
- S1更新状态：S1指标已更新到 20260608；本地 589720.SH 行情最新交易日为 20260608。
...
| 正面确认 | 负面确认 | 数据风险/不可确认 |
| --- | --- | --- |
| BD频率符合预期 | S2_conversion_score=0.55，修复但未确认 | S2-03b一致预期缺失 |
| BD金额质量符合预期 | S1-05=6.67%，breadth_collapse | Macro_Risk_Layer核心字段缺失1/10 |
| 产业事件侧得分0.64 | S2-04 success_rate=0.00% | missing |
| HK_observation=latest_valid | 159567跑输159557 | missing |
...
| 项目 | 昨日 | 今日 | 变化 | 解释 |
| --- | ---: | ---: | ---: | --- |
| S1_total | 0.61 | 0.68 | +0.07 | 温度计修复 |
| S2_adjusted | 0.54 | 0.61 | +0.07 | 产业事件侧较前一日改善；交易转化侧状态为交易转化修复中，但未确认。 |
| S2_event_score | 0.63 | 0.64 | +0.00 | 产业事件侧符合预期 |
| S2_conversion_score | 0.40 | 0.55 | +0.15 | 交易转化修复中，但未确认 |
| S2-04 pending | 7.00 | 3.00 | -4.00 | ASCO/临床事件等待满5个完整交易日 |
...
| 模块 | 状态 | 说明 |
| --- | --- | --- |
| S1 | valid | 589720行情和指标更新到20260608 |
| S2事件库 | valid | 今日新增0条确认事件 |
| 事件去重检查 | 有待复核 | is_duplicate=true 的事件不进入正式统计 |
| S2-04交易转化 | pending | raw_mature_event_count=7；deduped_trade_sample_count=6；3个事件未满5日 |
| HK_observation | latest_valid | source=cache；source_status=failed->failed；primary_source_status=failed；fallback_source_status=failed；latest_date_159567=20260608；latest_date_159557=20260608；common_trade_date=20260608；calendar_lag_days=0；trading_lag_days=0；report_day_price_available_externally=true；local_fetch_failed=false；data_fetch_failed=false |
| S2-03a财报客观改善 | valid | 财报客观改善样本有效 |
| S2-03b一致预期验证 | missing | 具备一致预期来源的业绩样本缺失 |
| S2-06商业化兑现质量 | scorable | 商业化核心公司覆盖=6/6；关键字段完整度=50%；缺失字段保留missing |
...
- S1_score_contribution：flow_score_contribution=0.400；price_strength_contribution=0.080；volume_contribution=0.056；breadth_contribution=0.056；leader_contribution=0.084。
- S1改善主要来自资金/份额流入，非价格强度和广度扩散。
- S1最新日期 20260608，综合得分 0.68，等级 符合预期；S1-02=9.15%，S1-05=6.67%，S1-06=1.60%。
...
| S2-03a | 财报客观改善 | 100.00% | 超预期 | 1.00 | 0.65 | 0.60 | 1 | 0 | 正式评分 | 0 | - | 财报客观改善样本 1/1；仅基于同比、利润改善、亏损收窄、现金流/经营改善等客观项，不代表超一致预期 |
| S2-03b | 一致预期验证 | 数据缺失 | 数据缺失 | 0.50 | 0.50 | 0.45 | 0 | 0 | 中性占位 | 0 | 具备一致预期来源的业绩样本缺失 | earnings_consensus.csv 无可靠一致预期来源；不得用同比增长冒充超预期 |
| S2-04 | 数据催化转化率 | 0.00% | 低于预期 | 0.40 | 0.40 | 0.70 | 6 | 3 | 正式评分 | 3 | 2096.HK待满5个交易日验证；6990.HK待满5个交易日验证；01801.HK待满5个交易日验证 | 正式口径：raw_mature_event_count=7；deduped_trade_sample_count=6；success_count=0；success_rate=0.00%；港股事件使用159557.SZ作宽基对照，A股事件使用589720.SH作温度计对照 |
| S2-05 | 龙头接力强度 | 0.78% | 符合预期 | 0.70 | 0.70 | 0.70 | 11 | 7 | 正式评分 | 0 | 589720.SH待满5个交易日验证 | 正式口径：核心催化后本地A股龙头池相对 589720.SH 的5日中位超额收益 0.78% |
...
- S2-04_official_sample_count：6。
- raw_mature_event_count：7。
- deduped_trade_sample_count：6。
- success_count：0。
- success_rate：0.00%。
- S2-04_hk_event_pending_count：4。
- S2-04_hk_event_pending_or_missing_count：4。
- HK_observation_status：159567 弱于 159557。
- 港股临床事件若本地 `s2/data/hk_daily.csv` 有完整个股价格，则进入 S2-04 正式样本；缺行情时列明缺失标的，不编造。
- 成熟可计算样本：6；等待满 5 日：3；港股行情缺失/待补：0；本地价格缺失：0。
- 样本数量满足，但交易转化失败。
- 下一批预计成熟日期：2026-06-09, 2026-06-10, 2026-06-11。
...
| 公司 | 标的 | 事件日期 | benchmark_code | window_days | trade_sample_id | mature_date | days_to_mature | 已过交易日 | 状态 | 说明 | 是否进入去重正式分 |
| --- | --- | --- | --- | ---: | --- | --- | ---: | ---: | --- | --- | --- |
| 康方生物 | 9926.HK | 2026-05-26 | 159557.SZ | 5 | 09926.HK\|20260526\|159557.SZ\|5 | 已满5日 | 0 | 9/5 | mature_calculable | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 6/5 | mature_calculable | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-05-29 | 159557.SZ | 5 | 06990.HK\|20260529\|159557.SZ\|5 | 已满5日 | 0 | 6/5 | mature_deduped_duplicate | 同一 stock_code + event_date + benchmark_code + window_days 已有正式交易样本，本项目仅保留明细 | 否 |
| 康方生物 | 9926.HK | 2026-05-31 | 159557.SZ | 5 | 09926.HK\|20260531\|159557.SZ\|5 | 已满5日 | 0 | 5/5 | mature_calculable | 成熟可算 | 是 |
| 迪哲医药 | 688192.SH | 2026-05-30 | 589720.SH | 5 | 688192.SH\|20260530\|589720.SH\|5 | 已满5日 | 0 | 5/5 | mature_calculable | 成熟可算 | 是 |
| 康宁杰瑞 | 9966.HK | 2026-06-01 | 159557.SZ | 5 | 09966.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 5/5 | mature_calculable | 成熟可算 | 是 |
| 先声再明 | 2096.HK | 2026-06-02 | 159557.SZ | 5 | 02096.HK\|20260602\|159557.SZ\|5 | 2026-06-09 | 1 | 4/5 | pending_not_enough_days | 未满5个完整交易日 | 否 |
| 亚盛医药 | 6855.HK | 2026-06-01 | 159557.SZ | 5 | 06855.HK\|20260601\|159557.SZ\|5 | 已满5日 | 0 | 5/5 | mature_calculable | 成熟可算 | 是 |
| 科伦博泰 | 6990.HK | 2026-06-03 | 159557.SZ | 5 | 06990.HK\|20260603\|159557.SZ\|5 | 2026-06-10 | 2 | 3/5 | pending_not_enough_days | 未满5个完整交易日 | 否 |
| 信达生物 | 01801.HK | 2026-06-04 | 159557.SZ | 5 | 01801.HK\|20260604\|159557.SZ\|5 | 2026-06-11 | 3 | 2/5 | pending_not_enough_days | 未满5个完整交易日 | 否 |
...
| hk_observation_return_159567 | -10.23% |
| hk_observation_return_159557 | -8.73% |
| hk_observation_excess_159567_vs_159557 | -1.50% |
...
- S2-06_missing：商业化核心公司覆盖=6/6；关键字段完整度=50%；缺失字段保留missing。
...
| latest_date_159567 | 20260608 |
| latest_date_159557 | 20260608 |
| common_trade_date | 20260608 |
| report_trade_date | 20260608 |
| lag_days_159567 | 0 |
| lag_days_159557 | 0 |
| calendar_lag_days | 0 |
| trading_lag_days | 0 |
| report_day_price_available_externally | true |
| local_fetch_failed | false |
| data_fetch_failed | false |
| 数据源 | citydata_fund_daily+eastmoney |
...
| 159567 1日收益 | -3.45% |
| 159557 1日收益 | -3.35% |
| 159567 - 159557 单日超额 | -0.10% |
| 159567 5日收益 | -10.23% |
| 159557 5日收益 | -8.73% |
| 159567 - 159557 5日超额 | -1.50% |
| 159567 10日收益 | -13.53% |
| 159557 10日收益 | -11.06% |
| 159567 - 159557 10日超额 | -2.47% |
...
| risk_off_defensive | true |
| ai_crowding_unwind | true |
| biotech_relative_strength | false |
| hk_innovation_vs_health | negative |
...
- 产业事件是否有效：是，S2_event_score=0.64。
- 交易转化是否确认：否，S2_conversion_score=0.55。
- 159567 是否强于 159557：港股创新药ETF弱于港股医疗宽基。
- 今日是否出现反证信号：是。
  - 159567 连续 4 日跑输 159557：港股创新药承接弱
  - S1_total=0.68 但 S1-05=6.67%：A股温度计可能虚修复
...
| 先声再明 / SIM0505 (CDH6 ADC) | 2096.HK | high | pending_not_enough_days | 数据缺失 | 数据缺失 | missing | 数据缺失 | 数据缺失 | missing |
| 亚盛医药 / olverembatinib (HQP1351) plus blinatumomab | 6855.HK | high | mature_calculable | -9.96% | 数据缺失 | missing | -1.23% | 数据缺失 | missing |
| 科伦博泰 / SKB500 (B7-H3 ADC) | 6990.HK | high | pending_not_enough_days | 数据缺失 | 数据缺失 | missing | 数据缺失 | 数据缺失 | missing |
| 信达生物 / IBI343 (arcotatug vedotin) | 01801.HK | high | pending_not_enough_days | 数据缺失 | 数据缺失 | missing | 数据缺失 | 数据缺失 | missing |

## 十、第四层：final_view_客观状态汇总

- 产业事件侧符合预期，但交易转化修复未确认；S1总分改善但广度坍缩；S2-04样本数量满足但成功率为0；159567同步行情已恢复，近5日相对159557仍偏弱，因此159567是否右侧仍需继续验证。
- final_view_code = C
...
- a_share_temperature_state = A股温度计中性，S1=0.68
- hk_observation_state = latest_valid，港股创新药 ETF 最近 5 个交易日弱于港股医疗宽基。
- hk_relative_state = 159567近5日弱于159557
- policy_risk_state = 政策风险升高
- macro_risk_state = risk_off_defensive=true；ai_crowding_unwind=true；biotech_relative_strength=false；hk_innovation_vs_health=negative
- main_positive_factors = BD频率符合预期；BD金额质量符合预期；产业事件侧得分0.64；HK_observation=latest_valid
- main_negative_factors = S2_conversion_score=0.55，修复但未确认；S1-05=6.67%，breadth_collapse；S2-04 success_rate=0.00%；159567跑输159557；Policy_Risk_Layer=risk_up
- next_validation_dates = 2026-06-09, 2026-06-10, 2026-06-11
...
### 基本面条件
- S1_total >= 0.60：满足，改善，当前0.68。
- S1-02 份额变化 >= 0：满足，当前9.15%。
- S1-05 板块广度 >= 40%：未满足，当前6.67%。
- S2_event_score >= 0.60：满足，改善，当前0.64。

### 交易转化条件
- S2_conversion_score >= 0.60：未满足，交易转化修复中，但未确认，当前0.55。
- S2-04 去重正式样本 >= 3：满足，当前6个；raw_mature_event_count=7。
- S2-04 success_rate > 0：未满足，success_count=0，success_rate=0.00%。
- S2-05 龙头接力中位超额收益 >= 0：满足，改善，当前0.78%。

### 持仓标的条件
- 159567 vs 159557 同步行情：满足，HK_observation_status=latest_valid。
- 159567 近5日强于159557：不可确认，最新判断超额=-1.50%；共同交易日历史超额=-1.50%。

### 数据质量条件
- HK日期同步：latest_date_159567=20260608；latest_date_159557=20260608；common_trade_date=20260608。
- S2-03b一致预期：missing；具备一致预期来源的业绩样本缺失。
- S2-06商业化兑现质量：scorable；商业化兑现质量通过样本 4/6；只判断收入、利润、现金流和现金余额等商业化质量，不替代S2-03。
