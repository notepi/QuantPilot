"""Independent AI/technology-growth style report.
...
from s2.style_rotation import StyleAnalysis, calculate_style_analysis
...
DEFAULT_AI_CORE_VERSIONS = PROJECT_ROOT / "s2" / "ai_core_versions.json"
