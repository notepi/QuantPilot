...
- audited_symbols=29
- can_use_for_latest_signal=false：7
- unstable_source：0
- blocked_symbols：01952.HK, 159557.SZ, 159567.SZ, 688180.SH, 688192.SH, 688266.SH, 688578.SH
...
| --- | ---: | ---: | --- | ---: |
| data/processed/market_daily.csv | 13426 | 6.88% | success:13426 | 100.00% |
| data/processed/macro_market_daily.csv | 137 | 18.31% | failed:1；success:136 | 100.00% |
| s2/output/data_audit/market_data_audit.csv | 29 | 26.39% | missing:29 | 96.55% |
| s2/data/clinical_trade_returns.csv | 10 | 15.79% | missing:10 | 0.00% |
