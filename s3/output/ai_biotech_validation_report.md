...
- 科技成长状态：TECH_GROWTH_2D_DOWN
- AI状态：AI_DOWN_RISK_OFF
- 市场状态：RISK_OFF
- 创新药相对医疗：-0.04%
- 创新药相对科技成长：3.35%
- 创新药相对AI_CORE：0.34%
...
| --- | --- | --- | ---: | ---: | --- |
| 20日 | 跑输科技成长 | 跑赢AI | 0.45000000 | 0.40000000 | 未获得稳定验证 |
| 60日 | 跑输科技成长 | 跑输AI | 0.31666667 | 0.43333333 | 未获得稳定验证 |
| 120日 | 跑输科技成长 | 跑输AI | 0.36666667 | 0.48333333 | 未获得稳定验证 |
| 250日 | 跑输科技成长 | 跑输AI | 0.41850220 | 0.45374449 | 存在统计信号，需结合经济意义 |
...
- 科技成长是否回调：是
- AI是否回调：是
- AI回调类型：AI_DOWN_RISK_OFF
- 市场是否Risk Off：是
- 159567绝对收益：-1.59%
- 159567相对159557超额：-0.04%
- 159567相对科技成长超额：3.35%
- 159567相对AI_CORE超额：0.34%
- 是否属于有效轮动：AI回调未带来创新药有效响应。

## 7. A股领先港股验证

- 当前最佳历史lead_signal：S1-04_upcross_1.00x
- S1是否先动：S1-04_upcross_1.00x，样本13，胜率0.69230769
- 可能领先窗口：2日
- 历史样本数：13
- 历史胜率：0.69230769
- 当前是否有效：未确认。
...
- 建议：hold
- 理由：right_side_score=68.61; score_status=descriptive_only; confidence=medium; thesis_state=weakened
- 下一增加条件：右侧确认评分>=70、置信度不低、159567相对159557和量能同时确认、反对证据少于2条。
- 下一减少条件：AI回调后159567仍不涨或跑输159557，或右侧评分<30，或S2_conversion继续低于0.60。
- 当前最强反对证据：159567绝对收益为负 -1.59% | 159567跑输159557 -0.04% | S2_conversion_score=0.50，交易转化未确认
