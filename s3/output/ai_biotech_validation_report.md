...
- 科技成长状态：TECH_GROWTH_2D_UP
- AI状态：AI_TREND_BREAK
- 市场状态：AI_STRONG_MARKET_RISK_OFF
- 创新药相对医疗：-0.73%
- 创新药相对科技成长：-4.34%
- 创新药相对AI_CORE：-4.85%
- 589720情绪状态：589720偏弱
...
| --- | --- | --- | ---: | ---: | --- |
| 20日 | 跑输科技成长 | 跑输AI | 0.50000000 | 0.40000000 | 未获得稳定验证 |
| 60日 | 跑输科技成长 | 跑输AI | 0.31666667 | 0.41666667 | 存在统计信号，需结合经济意义 |
| 120日 | 跑输科技成长 | 跑输AI | 0.39166667 | 0.48333333 | 未获得稳定验证 |
| 250日 | 跑输科技成长 | 跑输AI | 0.42152466 | 0.45291480 | 存在统计信号，需结合经济意义 |
...
- 科技成长是否回调：否
- AI是否回调：否
- AI回调类型：AI_TREND_BREAK
- 市场是否Risk Off：否
- 159567绝对收益：-3.87%
- 159567相对159557超额：-0.73%
- 159567相对科技成长超额：-4.34%
- 159567相对AI_CORE超额：-4.85%
...
- 建议：reduce
- 理由：right_side_score=28.35; score_status=descriptive_only; confidence=high; thesis_state=weakened
- 下一增加条件：右侧确认评分>=70、置信度不低、159567相对159557和量能同时确认、反对证据少于2条。
- 下一减少条件：AI回调后159567仍不涨或跑输159557，或右侧评分<30，或S2_conversion继续低于0.60。
- 当前最强反对证据：科技成长上涨时159567跑输TECH_GROWTH_CORE -4.34% | AI_CORE上涨时159567跑输AI_CORE -4.85% | 159567绝对收益为负 -3.87%
