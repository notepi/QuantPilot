...
- 科技成长状态：TECH_GROWTH_SINGLE_UP
- AI状态：AI_DOWN_RISK_ON
- 市场状态：AI_WEAK_MARKET_RISK_ON
- 创新药相对医疗：-0.17%
- 创新药相对科技成长：-0.86%
- 创新药相对AI_CORE：3.83%
...
| --- | --- | --- | ---: | ---: | --- |
| 20日 | 跑输科技成长 | 跑输AI | 0.30000000 | 0.45000000 | 未获得稳定验证 |
| 60日 | 跑输科技成长 | 跑输AI | 0.31666667 | 0.48333333 | 存在统计信号，需结合经济意义 |
| 120日 | 跑输科技成长 | 跑输AI | 0.37500000 | 0.49166667 | 存在统计信号，需结合经济意义 |
| 250日 | 跑输科技成长 | 跑输AI | 0.41588785 | 0.45794393 | 存在统计信号，需结合经济意义 |
...
- 科技成长是否回调：否
- AI是否回调：是
- AI回调类型：AI_DOWN_RISK_ON
- 市场是否Risk Off：否
- 159567绝对收益：2.75%
- 159567相对159557超额：-0.17%
- 159567相对科技成长超额：-0.86%
- 159567相对AI_CORE超额：3.83%
- 是否属于有效轮动：AI回调未带来创新药有效响应。
...
- AI资金虹吸假设：weakened：AI_CORE回调时159567上涨。
...
- 建议：hold
- 理由：right_side_score=51.61; score_status=descriptive_only; confidence=high; thesis_state=weakened
- 下一增加条件：右侧确认评分>=70、置信度不低、159567相对159557和量能同时确认、反对证据少于2条。
- 下一减少条件：AI回调后159567仍不涨或跑输159557，或右侧评分<30，或S2_conversion继续低于0.60。
- 当前最强反对证据：科技成长上涨时159567跑输TECH_GROWTH_CORE -0.86% | 159567跑输159557 -0.17% | S2_conversion_score=0.50，交易转化未确认
