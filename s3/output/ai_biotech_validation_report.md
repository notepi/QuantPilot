...
| 250日 | 跑输科技成长 | 跑输AI | 0.41314554 | 0.46009390 | 存在统计信号，需结合经济意义 |
...
- 市场是否Risk Off：否
- 159567绝对收益：-1.19%
- 159567相对159557超额：-0.34%
- 159567相对科技成长超额：0.42%
- 159567相对AI_CORE超额：-1.26%
...
- 历史样本数：10
- 历史胜率：0.80000000
- 当前是否有效：A股创新药同日较强但159567未跟随，不能称为领先有效。
...
- 建议：reduce
- 理由：right_side_score=47.03; score_status=valid; confidence=high; thesis_state=weakened
- 下一增加条件：右侧确认评分>=70、置信度不低、159567相对159557和量能同时确认、反对证据少于2条。
- 下一减少条件：AI回调后159567仍不涨或跑输159557，或右侧评分<30，或S2_conversion继续低于0.60。
- 当前最强反对证据：AI_CORE上涨时159567跑输AI_CORE -1.26% | 159567绝对收益为负 -1.19% | 159567跑输159557 -0.34%
